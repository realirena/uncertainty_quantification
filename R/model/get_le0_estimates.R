...
lifetable_f_age0 <- get_le0_dt(all_lifetable_f, "Females", 2024,"UN-IGME report",le0=le_noc_list[[4]])
lifetable_m_age0 <- get_le0_dt(all_lifetable_m, "Males", 2024, "UN-IGME report"  ,le0= le_noc_list[[4]])
lifetable_t_age0 <- get_le0_dt(all_lifetable_t, "Total", 2024, "UN-IGME report", le0=le_noc_list[[4]])
