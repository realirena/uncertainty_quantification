...
## B'tselem results
bts_le_m_age0 <- read.csv(paste0(results_dir, "bts_2024_m_le0.csv"))
bts_le_f_age0 <- read.csv(paste0(results_dir, "bts_2024_f_le0.csv"))
bts_le_t_age0 <- read.csv(paste0(results_dir, "bts_2024_t_le0.csv"))
...
###UN dist results 
un_le_m_geno24 <- read.csv(paste0(results_dir, "un_geno24_m_le0.csv"))
un_le_f_geno24 <- read.csv(paste0(results_dir, "un_geno24_f_le0.csv"))
un_le_t_geno24 <- read.csv(paste0(results_dir, "un_geno24_t_le0.csv"))
